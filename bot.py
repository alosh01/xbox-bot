...
# 1. إنشاء سيرفر وهمي لإبقاء البوت متصلاً
app = Flask('')
...
# 2. تشغيل السيرفر الوهمي أولاً
if __name__ == "__main__":
    keep_alive()
    
    # ----------------------------------------------------
    # الصق هنا كود البوت الأصلي الخاص بك (أكواد التكريك والفحص)
    # مثلاً: bot.infinity_polling() أو ما شابه لديك
    # ----------------------------------------------------
    import os
import sys
import time
