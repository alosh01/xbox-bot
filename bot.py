...
def send_welcome(message):
    bot.reply_to(message, "أهلاً بك يا علي! البوت صاروخي الآن. أرسل ملف الحسابات (.txt) ليبدأ الفحص السريع. 🚀")
...
def process_combo_file(chat_id, filename):
    ...
    # رفع عدد الخيوط لتسريع الفحص بشكل كبير
    threads = min(60, total_combos)
    ...
    summary = f"""<b>📊 ملخص فحص XBOX السريع (صاروخ)</b>
...
if __name__ == "__main__":
    keep_alive()
    print("Telegram Bot & Flask Server are running with high speed...")
